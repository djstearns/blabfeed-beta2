...
<?php echo $this->Form->create('Deviceuserlog');?>
	<fieldset>
 		<legend><?php __('Admin Edit Deviceuserlog'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Deviceuserlog.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Deviceuserlog.id'))); ?></li>
