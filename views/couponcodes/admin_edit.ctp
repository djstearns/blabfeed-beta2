...
<?php echo $this->Form->create('Couponcode');?>
	<fieldset>
 		<legend><?php __('Admin Edit Couponcode'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Couponcode.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Couponcode.id'))); ?></li>
