...
<?php echo $this->Form->create('BraintreeSubscription');?>
	<fieldset>
 		<legend><?php __('Admin Edit Braintree Subscription'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('BraintreeSubscription.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('BraintreeSubscription.id'))); ?></li>
