<div class="orders index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('trackingnum');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $order['Order']['ordernum']; ?>&nbsp;</td>
		<td><?php echo $order['Order']['orderdate']; ?>&nbsp;</td>
		<td><?php echo $order['Order']['trackingnum']; ?>&nbsp;</td>
