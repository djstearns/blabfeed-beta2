...
class GoogleMapV3Helper extends AppHelper {
	...
	protected $_defaultOptions = array(
		'zoom' =>10, # global, both map and staticMap
		'lat' => 41.2586, # global, both map and staticMap
		'lng' => -96, # global, both map and staticMap
		'type' => 'R',	
		'map'=>array(
			'api' => null,
...
/** Google Maps JS **/
	...
	function map($options = array()) {
		...
		$defaultText = isset($this->_currentOptions['content']) ? $this->_currentOptions['content'] : __('Map cannot be displayed HA!', true); 
