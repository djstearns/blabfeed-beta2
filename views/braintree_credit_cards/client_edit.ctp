...
<?php echo $this->Form->create('BraintreeCreditCard');?>
	<fieldset>
 		<legend><?php __('Client Edit Braintree Credit Card'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('BraintreeCreditCard.token')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('BraintreeCreditCard.token'))); ?></li>
