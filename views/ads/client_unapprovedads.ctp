        ...
        ?>
            ...
            <tr<?php echo $class;?>>
                ...
                <div>
 				...
 				Locations proposed:
                <?php echo $this->Html->link('Download', array('controller'=>'uploads', 'action'=>'download', $ad['Upload']['id']))?>
                            ...
                            <tr>
                                ...
                                //echo $location['AdsLocation']['id'] ;
                                 if ($location['AdsLocation']['approved'] == 1) {
                                    ...
                                    if($location['AdsLocation']['approved']=='1'){
                                        //echo $this->Form->input('AdsLocation.'.$r.'.approved', array('label'=>false, 'checked'=>true));
                                    }else{
                                        //echo $this->Form->input('AdsLocation.'.$r.'.approved', array('label'=> false));
                                    }
