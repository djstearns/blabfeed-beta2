...
<!--
DEREK's COMMMENT   ??????????????//////////////////
<link rel="icon" type="image/png" href="http://dev.blabfeed.com/editor/images/logo.png"/>
<link rel="stylesheet" href="http://dev.blabfeed.com/editor/jgraduate/css/jPicker.css" type="text/css"/>
<link rel="stylesheet" href="http://dev.blabfeed.com/editor/jgraduate/css/jgraduate.css" type="text/css"/>
<link rel="stylesheet" href="http://dev.blabfeed.com/editor/svg-editor.css" type="text/css"/>
<link rel="stylesheet" href="http://dev.blabfeed.com/editor/spinbtn/JQuerySpinBtn.css" type="text/css"/>
-->

<?php echo $this->Html->css(array('/editor/jgraduate/css/jPicker','/editor/jgraduate/css/jgraduate','/editor/svg-editor','/editor/spinbtn/JQuerySpinBtn')); ?>
...
<?php echo $this->Html->script(array(
	'/editor/other/base64',
	'/editor/other/canvas2image',
	'/editor/jquery',
	'/editor/js-hotkeys/jquery.hotkeys.min',
	'/editor/jquerybbq/jquery.bbq.min',
	'/editor/svgicons/jquery.svgicons',
	'/editor/jgraduate/jquery.jgraduate.min',
	'/editor/spinbtn/JQuerySpinBtn.min',
	'/editor/touch',
	'/editor/svgedit.compiled',
	)); ?>
<!-- 
DEREK's COMMENT ////////////////////////////////////
<script type="text/javascript" src="http://dev.blabfeed.com/editor/jquery.js"></script>
<script type="text/javascript" src="http://dev.blabfeed.com/editor/js-hotkeys/jquery.hotkeys.min.js"></script>
<script type="text/javascript" src="http://dev.blabfeed.com/editor/jquerybbq/jquery.bbq.min.js"></script>
<script type="text/javascript" src="http://dev.blabfeed.com/editor/svgicons/jquery.svgicons.js"></script>
<script type="text/javascript" src="http://dev.blabfeed.com/editor/jgraduate/jquery.jgraduate.min.js"></script>
<script type="text/javascript" src="http://dev.blabfeed.com/editor/spinbtn/JQuerySpinBtn.min.js"></script>
<script type="text/javascript" src="http://dev.blabfeed.com/editor/touch.js"></script>
-->


<!--{if svg_edit_release}-->
  <?php //echo $this->Html->script(array('/editor/svgedit.complied')) ?>
  <!--<script type="text/javascript" src="http://dev.blabfeed.com/editor/svgedit.compiled.js"></script>-->
<!--{else}>
...
<?php echo $this->Html->script(array('/editor/jquery-ui/jquery-ui-1.8.17.custom.min','/editor/jgraduate/jpicker')); ?>
<!--<script type="text/javascript" src="http://dev.blabfeed.com/editor/jquery-ui/jquery-ui-1.8.17.custom.min.js"></script>
<script type="text/javascript" src="http://dev.blabfeed.com/editor/jgraduate/jpicker.js"></script>
-->
<!-- feeds -->
