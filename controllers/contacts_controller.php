        ...
        if (!empty($this->data) && $continue === true) {
            ...
            if ($continue === true) {
                ...
                //unset($this->data['Message']);
                	...
                	echo $this->flash(__('Your message has been received and will be responded to by our staff.', true), '/');
				}else{
					echo $this->flash(__('Your message has been received to our administrators inbox.', true), '/');
				}
            }
        }
