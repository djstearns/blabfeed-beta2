...
class BraintreeSubscription extends BraintreeLocalAppModel {
 ...
 * @var string
 */
	public $name = 'BraintreeSubscription';
 ...
 * @return	bool
 */
	public function beforeSave ($dat=null) {
		
		if($this->data['BraintreeSubscription']['type'] == 'manual'){
			return true;
		}
