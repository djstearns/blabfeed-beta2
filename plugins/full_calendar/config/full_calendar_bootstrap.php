 ...
 */
    Croogo::hookRoutes('FullCalendar');
/**
 * Behavior
 *
 ...
 */
    Croogo::hookAdminMenu('FullCalendar');
/**
 * Admin row action
 *
 ...
 */
    Croogo::hookAdminRowAction('Nodes/admin_index', 'FullCaldendar', 'plugin:full_calendar/controller:full_calendar/action:index/:id');
/**
 * Admin tab
 *
 ...
 */
    Croogo::hookAdminTab('Nodes/admin_add', 'FullCalendar', 'full_calendar.admin_tab_node');
    Croogo::hookAdminTab('Nodes/admin_edit', 'FullCalendar', 'full_callendar.admin_tab_node');
?>